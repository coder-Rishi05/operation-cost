const shoulderDislocation = {
  "shoulder-dislocation": {
    ...
    types: [
      ...
      {
        title: "Inferior Shoulder Dislocation",
        description:
    ...
    treatmentInfo: {
      ...
      anaesthesia: "General",
      hospitalStay: "Same Day / 1 Day",
      treatedBy: "Orthopedic Shoulder Specialist",
      successRate: "95%+",
    ...
    faq: [
      {
        question: "Can a dislocated shoulder heal without surgery?",
        answer:
      ...
      {
        question: "Can I play sports again after surgery?",
        answer:
...
export default shoulderDislocation;
