const shoulderArthroscopy = {
  "shoulder-arthroscopy": {
    ...
    types: [
      {
        title: "Diagnostic Shoulder Arthroscopy",
        description:
    ...
    treatmentInfo: {
      ...
      anaesthesia: "General",
      hospitalStay: "Same Day",
      treatedBy: "Orthopedic Shoulder & Arthroscopy Surgeon",
      successRate: "95%+",
    ...
    faq: [
      {
        question: "What conditions can shoulder arthroscopy treat?",
        answer:
