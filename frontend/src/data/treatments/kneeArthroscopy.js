const kneeArthroscopy = {
  "knee-arthroscopy": {
    ...
    types: [
      ...
      {
        title: "Meniscus Repair / Meniscectomy",
        description:
    ...
    treatmentInfo: {
      ...
      hospitalStay: "Same Day",
      treatedBy: "Orthopedic Arthroscopy Surgeon",
      successRate: "95%+",
      recoveryTime: "2 Weeks – 6 Months",
    },

    cost: {
      india: "₹90,000 – ₹2,80,000",
      dependsOn: [
        "Procedure performed",
        "Hospital",
        "City",
    ...
    faq: [
      {
        question: "What conditions can be treated with knee arthroscopy?",
        answer:
      ...
      {
        question: "Is knee arthroscopy a major surgery?",
        answer:
