const carpalTunnel = {
  "carpal-tunnel": {
    ...
    recovery: {
      ...
      handMovement: "Immediately after surgery",
      officeWork: "1–2 Weeks",
      driving: "1–2 Weeks",
      fullRecovery: "6–12 Weeks",
    },
    ...
    treatmentInfo: {
      ...
      hospitalStay: "Same Day",
      treatedBy: "Orthopedic Hand Surgeon",
      successRate: "95%+",
    ...
    faq: [
      {
        question: "Can carpal tunnel syndrome go away without surgery?",
        answer:
      ...
      {
        question: "How long does carpal tunnel surgery take?",
        answer:
      ...
      {
        question: "Is carpal tunnel surgery successful?",
        answer:
